...
- `docs/authoring/` — 이 저장소의 문서를 만드는 규칙과 AI 활용 학습 자료 6편
...
- [`genai-for-beginners.md`](./docs/authoring/genai-for-beginners.md) — 생성형 AI 입문 (Microsoft [Generative AI for Beginners](https://github.com/microsoft/generative-ai-for-beginners) 커리큘럼 정리)
