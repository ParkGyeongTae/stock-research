...
*작성일: 2026-08-01 (최종 수정: 2026-08-15 — `.pages` nav 등록 규칙·로컬 빌드 확인 방법·문서 간 링크 규칙 추가, "알려진 예외" 기준 명시. 사업 고유 지표(`05_metrics.md` C절) 규칙 신설과 기존 문서 미적용 현황 등록, `meta/` 내부의 성격 구분(읽는 문서 vs 스캐폴딩) 명시)*
