...
<text x="1046.0" y="193.6" font-size="11.5" text-anchor="end" fill="var(--ink)" font-weight="700" paint-order="stroke" stroke="var(--bg)" stroke-width="3">현재 11,738.23 (2026-08-19)</text>
...
- 시가총액을 기준으로 비중을 매기는 지수라서, 엔비디아 같은 대형 회원사 몇 곳의 움직임이 지수 전체를 좌우할 수 있다 — 지수가 움직였다고 "반도체 업황 전체"가 그렇다고 곧바로 일반화하지 말고, 지수에서 비중이 큰 종목이 무엇인지 함께 확인한다.
