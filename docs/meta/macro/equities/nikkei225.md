...
!!! note ""
    최근 5년 닛케이225 지수(일본, `^N225`) 주봉 흐름을 지지선·저항선과 함께 정리한 참고 자료. `jpy_usd.md`(엔/달러)와 함께 보면 일본 시장·엔화 국면을 종합적으로 확인할 수 있다 — 엔 약세는 대개 일본 수출기업 실적 기대를 밀어올려 닛케이 강세와 같이 나타나는 경우가 많다.
