...
!!! note ""
    최근 5년 코스닥 지수(한국거래소 코스닥시장, 중소형·성장주 중심, `^KQ11`) 주봉 흐름을 지지선·저항선과 함께 정리한 참고 자료. `kospi.md`가 대형주 위주라면, 이 지수는 `russell2000.md`처럼 중소형·성장주 성격이 강해 국내 경기·위험선호에 더 민감하게 반응하는 편이다.
