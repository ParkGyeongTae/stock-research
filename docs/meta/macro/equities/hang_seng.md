...
!!! note ""
    최근 5년 항셍지수(홍콩거래소, `^HSI`) 주봉 흐름을 지지선·저항선과 함께 정리한 참고 자료. 중국 본토 규제·경기와 홍콩 금융시장 유동성이 겹쳐 반영되는 지수라, 중화권 리스크 센티먼트를 볼 때 닛케이225 같은 다른 아시아 지수와 함께 시장 배경으로 참고한다.
...
- **참고**: 홍콩달러는 미달러에 페그(고정환율)돼 있어 홍콩 금리가 사실상 연준 정책을 따라간다. 지수 구성에서 H주(중국 본토 기업의 홍콩 상장주) 비중이 커서, 사실상 중국 정책·경기 리스크에 직접 노출된 지수라고 봐야 한다.
