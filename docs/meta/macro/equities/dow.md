...
!!! note ""
    최근 5년 다우존스산업지수(우량주 30종목, `^DJI`) 주봉 흐름을 지지선·저항선과 함께 정리한 참고 자료. 시가총액 가중이 아니라 **주가 가중** 방식이라 `sp500.md`·`nasdaq.md`와 계산 방식 자체가 다르다 — 종목 수가 적고(30개) 전통 산업재·금융 비중이 커서, 성장주 중심의 나스닥과는 다른 흐름을 보일 때가 있다.
