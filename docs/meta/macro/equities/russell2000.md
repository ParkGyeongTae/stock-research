...
!!! note ""
    최근 5년 러셀2000 지수(미국 중소형주 2,000종목, `^RUT`) 주봉 흐름을 지지선·저항선과 함께 정리한 참고 자료. `sp500.md`·`nasdaq.md`·`sox.md`가 전부 대형주 위주 지수인 것과 달리, 이 지수는 **미국 국내 경기에 더 민감한 중소형주**를 담아 다른 신호를 준다 — 대형주 지수는 오르는데 러셀2000이 약하면 시장 강세가 소수 대형주에 쏠려 있다는 신호로 읽히곤 한다.
