# 원달러 환율 (USD/KRW) — 기술적 참고 (주봉 5년)

> 최근 5년 원/달러(1달러당 원화, `KRW=X`) 주봉 가격 흐름을 지지선·저항선과 함께 정리한 참고 자료. 특정 회사 문서가 아니라 **여러 회사 문서에서 공통으로 인용하는 거시 참고 차트**다 — 해외 매출 비중이 큰 회사의 환율 민감도를 Bear/Bull Case에서 다룰 때, 혹은 상수통화(constant currency) 성장률과 보고 성장률의 괴리를 설명할 때 이 문서를 인용한다.
>
> **이 문서는 과거 가격 패턴에 대한 객관적 서술이며, 환율 전망이나 투자 판단이 아니다.** 왜 그렇게 다뤄야 하는지는 [`concepts/macroeconomics.md`](../../concepts/macroeconomics.md) "거시를 어디까지 쓸 것인가"를 따른다 — 이 레포는 거시 전망 자체를 투자 논거의 중심에 두지 않는다.
>
...
@media (prefers-color-scheme: dark) {
  .krw-x-chart { --bg:#1a1a19; --grid:#2c2c2a; --axis:#383835; --ink:#ffffff; --ink2:#c3c2b7; --muted:#898781; --up:#0ca30c; --down:#e66767; --support:#3987e5; --resistance:#d95926; --ref:#898781; }
}
...
<text x="52" y="426.0" font-size="11" text-anchor="end" fill="var(--muted)">1,300</text>
<line x1="60" y1="302.0" x2="1052" y2="302.0" class="grid"/>
<text x="52" y="306.0" font-size="11" text-anchor="end" fill="var(--muted)">1,400</text>
<line x1="60" y1="182.0" x2="1052" y2="182.0" class="grid"/>
<text x="52" y="186.0" font-size="11" text-anchor="end" fill="var(--muted)">1,500</text>
<line x1="60" y1="62.0" x2="1052" y2="62.0" class="grid"/>
<text x="52" y="66.0" font-size="11" text-anchor="end" fill="var(--muted)">1,600</text>
...
<rect x="60.72" y="571.4" width="2.34" height="2.7" fill="var(--down)"/>
...
<line x1="1046.3" y1="282.7" x2="1046.3" y2="321.0" stroke="var(--down)" class="wick"/>
<rect x="1045.17" y="283.5" width="2.34" height="2.2" fill="var(--down)"/>
<line x1="1050.1" y1="306.1" x2="1050.1" y2="321.1" stroke="var(--up)" class="wick"/>
<rect x="1048.94" y="307.2" width="2.34" height="10.3" fill="var(--up)"/>
<line x1="60" y1="301.8" x2="1052" y2="301.8" stroke="var(--resistance)" stroke-width="1.4" stroke-dasharray="6,4"/>
<text x="1058" y="305.3" font-size="11.5" fill="var(--resistance)" font-weight="600">1,400원 R1</text>
...
<text x="1058" y="202.2" font-size="11.5" fill="var(--resistance)" font-weight="600">1,486원 R2</text>
...
<text x="1058" y="371.5" font-size="11.5" fill="var(--support)" font-weight="600">1,337원 S1</text>
...
<text x="1058" y="443.0" font-size="11.5" fill="var(--support)" font-weight="600">1,277원 S2</text>
...
| 레벨 | 가격 | 터치 횟수 | 비고 |
|------|------|-----------|------|
| R2 | 1,486원 | 3 | 2024-12-23·2025-04-07·2025-12-22 — 최근 1년 사이 반복된 상단 |
| R1 | 1,400원 | 3 | 2024-04-15·2024-06-24·2025-07-28 — 심리적 레벨(1,400원)과 겹침 |
| **현재가** | **1,395.68원** (2026-08-20 종가) | — | R1과 S1 사이 |
| S1 | 1,337원 | 5 | 2024-05-13·2024-08-19·2025-01-20·2025-06-30·2025-11-24 — 최근 1년 레인지의 하단 |
| S2 | 1,277원 | 5 | 2023-03-20·2023-07-17·2023-12-25·2024-02-05·2024-09-30 — 2023~2024년 레인지의 하단 |
| S3 | 1,214원 | 4 | 2022-02-21·2022-05-30·2023-01-30·2024-03-11 — 2022년 초부터 2024년 초까지 걸쳐 반복된 다년 저점대 |
...
<!-- 최근 5년 최고 1,587.70 / 최저 1,145.08 / y축 1,130.00~1,605.00 / 주평균 거래량 0주 -->
<!-- 04_metrics.md/06_valuation.md 대조용 종가 -->
<!-- 2026-08-20 종가 1,395.68원 -->

- **한계**:
    - 후행적(과거 데이터 기반) 지표다. 특정 환율이 지지·저항으로 "작동할 것"을 보장하지 않는다.
    - 이동평균·추세선 등 다른 기술적 지표는 포함하지 않았다 — 스윙 고점/저점 빈도만 반영한 단순 모델이다.
    - 원/달러는 한국은행·연준 통화정책, 무역수지, 위험선호(risk-on/off) 등 여러 요인이 겹쳐 움직인다 — 이 차트만으로 방향을 예단하지 않는다. 경로에 대한 설명은 [`concepts/macroeconomics.md`](../../concepts/macroeconomics.md) "환율" 절 참고.
...
```bash
uv run python scripts/gen_technical_chart.py "KRW=X" --name "원달러 환율" --interval 1wk \
...
uv run python scripts/gen_technical_chart.py "KRW=X" --interval 1wk --emit dates
```

`--close-on`에는 이 값을 인용하는 회사 문서(예: 해외 매출 비중이 큰 회사의 `06_valuation.md`)와 대조할 날짜를 넣는다. `--emit dates` 출력은 레벨(R1/S1 등)별 날짜 목록이며, 그 시기에 무슨 일이 있었는지(국면 해석)는 자동으로 나오지 않으니 직접 확인해서 덧붙인다.
