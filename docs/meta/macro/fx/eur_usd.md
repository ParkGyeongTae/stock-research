# 유로/달러 (EUR/USD) — 기술적 참고 (주봉 5년)

> 최근 5년 유로/달러 환율(1유로당 USD, `EURUSD=X`) 주봉 흐름을 지지선·저항선과 함께 정리한 참고 자료. [`dxy.md`](./dxy.md)(달러인덱스)의 최대 비중(약 58%) 구성 통화쌍이 바로 이것이라, DXY 움직임의 대부분은 사실상 이 환율이 주도한다 — DXY가 왜 움직였는지 더 세밀하게 보고 싶을 때 이 문서를 함께 본다.
>
...
각 레벨은 "전후 4주 내 최고/최저인 스윙 포인트"를 가격 기준 ±2.5% 이내로 묶은 클러스터다. 터치 횟수는 그 클러스터에 포함된 스윙 포인트 개수(강도 근사치)를 뜻하며, 미래 지지/저항을 보장하지 않는다(§3 한계 참고). 단위는 1유로당 USD다.

| 레벨 | 가격 | 터치 횟수 | 비고 |
|------|------|-----------|------|
| R1 | $1.19 | 4 | 2025-06-30·2025-09-15·2026-01-26·2026-04-13 |
| **현재가** | **$1.17** (2026-08-20 종가) | — | R1과 S1 사이 |
| S1 | $1.14 | 6 | 2025-07-28·2025-11-03·2026-01-12·2026-03-16·2026-06-22·2026-07-27 |
| S2 | $1.10 | 3 | 2021-11-22·2022-03-07·2025-05-12 |
| S3 | $1.05 | 8 | 2022-05-09·2023-03-13·2023-05-29·2023-10-02·2024-02-12·2024-04-15·2024-06-24·2024-11-18 |
...
<!-- 최근 5년 최고 1.20 / 최저 0.92 / y축 0.91~1.22 / 주평균 거래량 0주 -->
...
- **한계**:
    ...
    - [`dxy.md`](./dxy.md)와 상당 부분 같은 정보를 담는다 — 두 문서를 각각 독립 근거로 중복 인용하지 않는다.
...
uv run python scripts/gen_technical_chart.py "EURUSD=X" --interval 1wk --emit dates
```
