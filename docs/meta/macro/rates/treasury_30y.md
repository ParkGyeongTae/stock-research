# 미국 30년물 국채금리 — 기술적 참고 (주봉 5년)

> 최근 5년 미 국채 30년물 수익률(`^TYX`) 주봉 흐름을 지지선·저항선과 함께 정리한 참고 자료. [`short_rate.md`](./short_rate.md)(13주)·[`treasury_5y.md`](./treasury_5y.md)(5년)·[`treasury_10y.md`](./treasury_10y.md)(10년)와 함께 **수익률곡선의 최장기 구간**을 채운다.
>
...
| 레벨 | 가격 | 터치 횟수 | 비고 |
|------|------|-----------|------|
| **현재가** | **5.19%** (2026-08-17 종가) | — | 기간 내 상단 저항 없음(신고가 구간) — 가장 가까운 지지는 S1 |
| S1 | 4.78% | 3 | 2025-06-30·2025-08-04·2026-06-22 |
| S2 | 4.58% | 2 | 2025-10-20·2026-02-23 |
| S3 | 4.33% | 3 | 2024-06-10·2024-12-02·2025-03-31 |
...
<!-- 최근 5년 최고 5.33 / 최저 1.68 / y축 1.55~5.45 / 주평균 거래량 0주 -->
...
- **한계**:
    ...
    - 30년물은 이 레포 밸류에이션(DCF 무위험이자율)의 표준 근거로 쓰지 않는다 — 표준은 10년물([`treasury_10y.md`](./treasury_10y.md))이다. 이 문서는 수익률곡선 형태를 보기 위한 보조 자료다.
...
```bash
uv run python scripts/gen_technical_chart.py "^TYX" --name "미 국채 30년물 금리" --interval 1wk \
...
uv run python scripts/gen_technical_chart.py "^TYX" --interval 1wk --emit dates
```

[`short_rate.md`](./short_rate.md)·[`treasury_5y.md`](./treasury_5y.md)·[`treasury_10y.md`](./treasury_10y.md)도 같은 `--close-on` 날짜로 함께 갱신하면 네 문서의 종가를 바로 대조해 수익률곡선 전체 형태를 확인할 수 있다.
