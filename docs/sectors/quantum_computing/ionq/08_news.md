...
> ⚠️ 이 문서는 시점성 메모(로그)다. 판단은 여기서 내리지 않고, 영향이 있으면 `06_valuation.md`·`07_investment.md`를 직접 갱신한다.
...
| 2025-07-11 | Capella Space 인수 종결 | 우주 기반 QKD 네트워크 지원, 대가 약 $424.8M | [`02_history.md`](./02_history.md) | SEC 8-K |
| 2025-06 | Lightsynq 인수 · Oxford Ionics 인수 계획 발표 | 광자 인터커넥트(Lightsynq) 인수, Oxford Ionics 인수 발표(9월 종결) | [`02_history.md`](./02_history.md) | 각사 보도자료 |
| 2025-05 | ID Quantique 인수 | 스위스 양자내성암호·센싱 기업 편입 | [`02_history.md`](./02_history.md) | IonQ 보도자료 |
| 2025-02-24 | CEO 교체 | Niccolo de Masi가 President 겸 CEO 취임, Peter Chapman은 Executive Chair로 이동 → 03§CEO에 반영 | [`03_ceo.md`](./03_ceo.md) | [IonQ IR](https://investors.ionq.com/news/news-details/2025/IonQ-Names-Niccolo-de-Masi-as-President--Chief-Executive-Officer/default.aspx) |
