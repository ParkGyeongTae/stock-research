...
| 참고선 | $445 | — | 5년 최고(2025-07-14). 2026-07-31 Q2 실적발표 갭다운(기술적 분석 — 일봉·1년 §3) 이후 레짐이 재설정됐고, 애초에 현재가 대비 3배 가까이 괴리돼 있어 근시일 저항으로 보지 않음 |
...
- 이 폭락·회복 사이클은 회사 고유 이슈보다 크립토 자산 가격 전반의 사이클(비트코인·이더리움 등)에 연동된 것에 가깝다 — 개요·투자 판단가 짚는 "크립토 시장 구조적 변동성 노출" 리스크가 가격에 그대로 나타난 역사적 사례로 볼 수 있다. 기술적 분석 — 일봉·1년 §3의 2026-07-31 실적발표 갭다운(회사 고유·최근 이벤트)과는 시점·원인이 다르므로 혼동하지 말 것.

---

## 4. 방법론 · 한계

- **데이터**: Yahoo Finance 주봉 OHLCV(주간 시가/고가/저가/종가/거래량, 주 마지막 거래일 기준), 262개 주, 2021-08-16~2026-08-14. 수집 시점: 2026-08-16. 원주가(과거 분할은 소급 반영, 배당은 미반영) — Coinbase는 2021년 상장 이후 분할·병합 이력이 없다(역사 / 주요 이벤트·기술적 분석 — 일봉·1년 §4와 동일 확인). 무배당 기업이라 배당 관련 조정 이슈 자체가 없다(핵심 지표 A.4).
...
- **한계**:
    ...
    - 기술적 분석 — 일봉·1년 §3의 2026-07-31 실적발표 갭다운처럼 뉴스 이벤트로 인한 불연속 구간은 통상적인 지지/저항 해석이 적용되기 어렵다.
