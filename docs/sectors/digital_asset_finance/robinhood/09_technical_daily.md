...
- 2026-04-28 장 마감 후 발표된 1분기 실적에서 EPS($0.38)·매출($1.07B)이 모두 컨센서스(EPS $0.42, 매출 $1.14B)를 하회했다. 크립토 거래 매출이 전년 동기 대비 47% 급감한 것이 주된 원인으로 지목됐다[^q1miss]. 재무 / 실적 §1, 최근 뉴스 / 이슈 2026-04-28 로그 참고.
...
> 위 3건 외에도 2025-11-06(3분기 실적 반응, -10.8%)·2026-07-30(2분기 실적 반응, -3.6%) 등 분기 실적 발표일 전후로 크고 작은 변동이 반복됐다 — Robinhood는 분기별 크립토·이벤트 계약 매출 변동성이 커(재무 / 실적 §1) 실적 발표일 자체가 구조적으로 큰 갭을 만드는 종목이라는 점을 감안해야 한다. 위 3건은 그중 자료로 확인 가능했던 최대 폭의 사례만 다뤘다.
