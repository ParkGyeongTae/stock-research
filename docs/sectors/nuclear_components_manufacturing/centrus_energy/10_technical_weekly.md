...
- **2026년: 대조정과 개별 계약 뉴스**: 2026년 1월 DOE $900M HALEU 증설 계약이라는 강한 펀더멘털 호재에도 불구하고, 그 전후로 밸류에이션 부담에 따른 대규모 조정이 함께 진행돼 현재가는 이 고점 대비 −62% 낮은 수준이다 — 호재 하나로 조정을 되돌리기엔 그 전 랠리의 되돌림 폭이 훨씬 컸다는 뜻으로 해석할 수 있다(밸류에이션 / 적정주가 §2·기술적 분석 — 일봉·1년 §3와 같은 결론).
