...
> ⚠️ 이 문서의 가격 데이터는 핵심 지표의 원자료 표와는 별도로, 이 차트 작성을 위해 일봉 API(Yahoo Finance)에서 직접 수집한 것이다(1년 일봉은 핵심 지표가 다루는 범위 밖이라 단일 출처 규칙의 예외). 대신 겹치는 시점의 종가를 대조한 결과: `2026-04-30`(FY2026 회계연도 말) 종가 $195.02는 [핵심 지표](./04_metrics.md) A.2·[밸류에이션 / 적정주가](./06_valuation.md) 2. 최근 3개년 — 적정주가 vs 실제주가에 인용된 값과 **일치**한다. 이 문서의 최신 종가($192.81, 2026-08-14)는 개요·밸류에이션 / 적정주가가 인용하는 기준일(2026-08-13, $189.43)보다 하루 늦은 시점의 값으로, 하루 사이 +1.78% 상승한 결과다 — 오차가 아니라 수집 시점 차이임을 밝혀둔다.
...
| R1 | $220 | 2 | 2026년 4월(4/21)·5월(5/28) 스윙 고점 — Q3 실적 충격(3-A. 2026-03-10~11 — FY2026 3분기 실적·Space 손상 최초 발표 충격) 이후 반등 상단 |
| **현재가** | **$192.81** (2026-08-14 종가) | — | R1과 S1 사이 |
| S1 | $175 | 2 | 2026년 3월 말(3/30)·4월 초(4/10) 스윙 저점 — Q3 실적·Space 손상 충격 직후 저점대 |
| S2 | $140 | 2 | 2026년 7월(7/15, 7/30) 스윙 저점 — 재작성 공시(3-B. 2026-06-22 — 10-Q/A 재작성·내부통제 취약점 공시) 이후 형성된 최근 저점대 |
...
- 2026-03-10 장중 FY2026 3분기 실적 발표 — Space 보고단위 영업권 손상 $151.3M 최초 인식, 미 우주군 SCAR 프로그램 계약 해지·재입찰 필요 공시([역사 / 주요 이벤트](./02_history.md), [최근 뉴스 / 이슈](./08_news.md) 참고. 이 손상액은 이후 2026-06-22 10-Q/A로 $240.7M까지 확대 정정됨).
...
- 2026-06-22 Space 보고단위 영업권 손상 계산 오류(인수 이연법인세 자산·부채 배분 누락)로 10-Q/A 제출, 손상액 $89.4M 추가(누적 $240.7M)로 확대 정정, 내부통제 중요한 취약점 공시([역사 / 주요 이벤트](./02_history.md), [최근 뉴스 / 이슈](./08_news.md) 참고).
...
- 2026-06-29 장 마감 후 FY2026 4분기·연간 실적 발표 — 4분기 매출 $641.6M(YoY +133%), 흑자 전환(EPS $1.25), 펀디드 백로그 $1.2B로 확대([최근 뉴스 / 이슈](./08_news.md) 참고).
...
- **한계**:
    ...
    - 최근 1년간 세 차례의 정보 이벤트(3-A. 2026-03-10~11 — FY2026 3분기 실적·Space 손상 최초 발표 충격·3-B. 2026-06-22 — 10-Q/A 재작성·내부통제 취약점 공시·3-C. 2026-06-30 — FY2026 4분기 실적 서프라이즈(매출 +133%))로 가격 레짐이 반복적으로 단절됐다 — 특히 3월·6월 저점 구간은 펀더멘털 악재로 인한 급락이라 "지지선"의 기술적 의미(수요 유입)보다 "패닉 이후 반등 시작점"에 가까울 수 있다는 점을 감안해서 읽을 것.
...
- [Yahoo Finance — AeroVironment, Inc. (AVAV) 일봉 시세](https://finance.yahoo.com/quote/AVAV/history/)
