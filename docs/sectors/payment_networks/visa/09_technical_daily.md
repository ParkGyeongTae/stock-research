...
> ⚠️ 이 문서의 가격 데이터는 핵심 지표의 원자료 표와는 별도로, 이 차트 작성을 위해 일봉 API(Yahoo Finance)에서 직접 수집했다(1년 일봉은 핵심 지표가 다루는 범위 밖이라 단일 출처 규칙의 예외). 겹치는 시점의 종가를 대조한 결과: `2025-09-30` 종가 $341.38은 [핵심 지표](./04_metrics.md) A.2·[밸류에이션 / 적정주가](./06_valuation.md) 2. 최근 3개년 — 적정주가 vs 실제주가에 인용된 FY2025 회계연도 말 종가와 **일치**한다. `2026-08-14` 종가 $364.15도 [개요](./01_overview.md)·[밸류에이션 / 적정주가](./06_valuation.md)에 인용된 현재주가와 **일치**한다.
...
- 2026-04-28(화) 장 마감 후 Visa가 FY2026 2분기 실적을 발표(순매출 +17% YoY, GAAP EPS +36% YoY, Non-GAAP EPS +20% YoY) — 관련 원자료는 [핵심 지표](./04_metrics.md) B절, 발표 사실 로그는 [최근 뉴스 / 이슈](./08_news.md) 참고.
- 종가 기준 전일(2026-04-28, $309.30) 대비 **+8.26%** ($309.30 → $334.86, 2026-04-29), 거래량은 직전 20거래일 평균(약 700만 주) 대비 약 2.4배인 **1,666만 주**.
- 이 갭 이후 주가는 2026년 5~6월 한동안 $310~$345 박스권에서 등락했으나, 2026년 7월 FY2026 3분기 실적(2026-07-28 발표, 매출 +14%)을 계기로 재차 상승해 8월 초 52주 최고가($373.97)를 경신했다 — 4월 갭 이후 형성된 새 지지대(S2 $334)가 그 사이 실제로 여러 차례 지지선 역할을 한 것으로 보인다(2. 지지선 / 저항선 요약 터치 횟수 3회).
...
- [Yahoo Finance — Visa Inc. (V) 일봉 시세](https://finance.yahoo.com/quote/V/history/)
