...
>
> ⚠️ **"C. 사업 고유 지표" 절 생략**: EDA 섹터 표준 지표(예: backlog·RPO 등)가 아직 정해지지 않아 이 절을 생략함. 같은 섹터의 Cadence 문서도 동일하게 생략된 상태 — 섹터 표준 지표를 정할 때 두 회사 문서에 함께 반영할 것(`docs/meta/.template/company/04_metrics.md` C절 규칙 참고).
...
|------|--------|--------|--------|--------|--------|-----------|------|--------|
| 주가 (회계연도 말 종가) | $333.18 (2021.10.29) | $292.55 (2022.10.31) | $469.44 (2023.10.31) | $518.40 (2024.11.1) | $453.82 (2025.10.31) | $397.87 (2026.8.21 종가) | $409.36 | $421.29 |
| 발행주식수 (희석, 백만주) | 157.3 | 156.5 | 155.2 | 155.9 | 165.7 | 약 192.3 (FY2026 Q2 기준) | 163.8 | 156.9 |
| 시가총액 | 50,997 | 44,577 | 71,380 | 79,892 | 84,408 | 약 76,510 (주가×희석주식수) | 67,671 | 73,075 |
| PER (GAAP 기준) | 69.27 | 46.51 | 59.27 | 56.04 | 56.24 | 92.10 (TTM GAAP EPS $4.32 기준) | 62.89 | 57.76 |
| PER (Non-GAAP 기준) | 48.71 | 32.87 | 41.95 | 39.27 | 35.15 | 29.67 (TTM Non-GAAP EPS $13.41 기준) | 37.82 | 37.21 |
| BPS (자기자본 ÷ 희석주식수, 아래 A.3 자기자본 기준) | $33.69 | $35.28 | $39.65 | $57.68 | $170.96 | $158.49 (2026.4.30 자기자본 기준) | $82.63 | $48.67 |
| PBR (주가 ÷ BPS) | 9.89 | 8.29 | 11.84 | 8.99 | 2.65 | 2.51 | 7.35 | 8.64 |
| 순부채 (아래 A.3 참조, 순현금이면 음수) | -914.2 (순현금) | -909.6 (순현금) | -908.4 (순현금) | -3,365.5 (순현금) | 11,332.0 | 8,360.0 (2026.8.21 기준) | 2,265.7 | -909.0 |
| EV (시가총액 + 순부채) | 50,082.8 | 43,667.4 | 70,471.6 | 76,526.5 | 95,740.0 | 약 84,870 (주7) | 69,924.7 | 73,499.1 |
| EV / 매출 | 11.91 | 8.59 | 12.06 | 12.49 | 13.57 | 9.74 (주7) | 11.45 | 11.99 |
| EV / EBITDA | 45.96 | 28.39 | 41.47 | 42.03 | 54.84 | 49.84 (주7) | 41.80 | 41.75 |
...
- "올해(현재)" PER은 회계연도가 아직 끝나지 않아, 최근 4개 분기 합산(TTM) EPS 기준으로 계산. 참고로 FY2026 Non-GAAP EPS 가이던스 중간값($14.76) 기준 forward PER은 약 26.96배.
- 시가총액(올해/현재)은 2026-08-21 실제 종가(가장 최근 확인된 거래일 종가, stockanalysis.com 기준) × 희석주식수(FY2026 Q2 공시 기준 추정치)로 계산 — 종가는 실측이나 희석주식수는 여전히 근사치임에 유의.
- BPS·PBR은 A.3의 자기자본·A.1의 희석주식수를 인용해 계산(직접 새 수치를 만들지 않음). 밸류에이션 / 적정주가는 이 행을 그대로 인용할 것.
- (주7) "올해(현재)" EV/매출·EV/EBITDA는 stockanalysis.com 통계 페이지(2026-08-22 접속 기준, EV $84.54B·EV/Sales 9.74·EV/EBITDA 49.84) 원자료를 인용. 총차입금($10.84B)·현금($2.48B)은 2026-08-14 접속 시점과 변동이 없어 순부채(8,360.0)는 동일하다. EV/EBITDA가 이전 버전(38.11) 대비 큰 폭으로 뛴 것은 EV 자체 변동(주가 하락으로 오히려 소폭 감소)이 아니라 stockanalysis.com이 인식하는 TTM EBITDA 추정치가 낮아진 영향으로 보이며, 다음 분기(FY2026 Q3, 2026-08-26 발표 예정) 실적 확정 전까지는 **확인 필요**로 남긴다. EV 행 자체는 본 표의 시가총액(약 76,510, 2026-08-21 종가 기준)+순부채(8,360) 기준 자체 계산치(약 84,870)로 대체 표기함 — stockanalysis.com 자체 EV($84.54B)와 큰 차이 없음(자체 발행주식수 추정치 차이로 인한 소폭 격차). EV/매출·EV/EBITDA 배수는 stockanalysis.com 값을 그대로 인용.
- (주7a) **가격 기준일 통일 참고**: 이번 갱신으로 개요·본 문서·밸류에이션 / 적정주가·투자 판단·최종 보고서는 2026-08-21 종가($397.87)로 통일했다. 기술적 분석 — 일봉·1년·기술적 분석 — 주봉·5년의 캔들차트는 아직 2026-08-14 종가($421.50)까지의 데이터만 반영하고 있어(차트 재생성 전), 두 문서의 "현재가"가 다른 문서보다 며칠 뒤처져 있다는 점에 유의할 것.
...
| 이자부 차입금 (단기+장기+리스부채) | 666.8 | 656.4 | 677.6 | 684.5 | 14,293.0 | 10,840.0 (2026.8.21 기준) | 4,636.4 | 681.1 |
| 현금및현금성자산 + 단기투자자산 | 1,581.0 | 1,566.0 | 1,586.0 | 4,050.0 | 2,961.0 | 2,480.0 (2026.8.21 기준) | 2,370.7 | 2,033.0 |
| 순부채 (이자부 차입금 − 현금성자산) | -914.2 | -909.6 | -908.4 | -3,365.5 | 11,332.0 | 8,360.0 | 2,265.7 | -909.0 |
| 이자비용 (주9) | 3.37 | 1.70 | 2.70 | 36.83 | 446.73 | 확인 필요 (TTM 약 637.3, 아래 참고) | 98.27 (5개년) | 3.37 (5개년) |
| 이자보상배율 (영업이익 ÷ 이자비용, 배) | 218.04 | 683.53 | 470.00 | 36.81 | 2.05 | 약 0.96 (TTM, 주9) | 282.09 (5개년) | 218.04 (5개년) |
...
- (주9) 이자비용은 stockanalysis.com 연간/분기별 손익계산서(2026-08-22 접속)를 인용 — 분기 합산치(FY2025 4개 분기 합 $446.72M)가 연간 공시치($446.73M)와 사실상 일치해 정합성을 확인했다. **TTM(현재) 이자비용** $637.33M은 FY2025 Q3($146.50M)+Q4($194.75M)+FY2026 Q1($162.72M)+Q2($133.36M) 합산. TTM 이자보상배율은 이 TTM 이자비용을 위 B절의 GAAP 영업이익 TTM 합산치($610.1M = FY2025 Q3~FY2026 Q2 실측 합산)로 나눈 값이며, **1배 미만(약 0.96배)으로 최근 4개 분기 GAAP 영업이익이 이자비용을 채 감당하지 못하는 수준**이다 — FY2021~FY2024엔 최소 36.8배였던 것과 극명하게 대비된다. 다만 이는 Ansys 인수 관련 무형자산 상각·구조조정 비용이 GAAP 영업이익을 일시에 크게 눌러 생긴 결과로 보이며(A.1 참고), Non-GAAP 영업이익 기준으로는 훨씬 여유가 있을 가능성이 높다 — Non-GAAP 기준 이자보상배율은 별도로 확인되지 않아 **확인 필요**로 남긴다.
- ⚠️ 위 "총부채(부채총계)"와 "이자부 차입금"은 다른 개념이다 — 부채비율은 부채총계 기준, 순부채·EV는 이자부 차입금 기준으로 계산했다([용어집](../../../meta/glossary.md) "부채비율"·"순부채" 참고). FY2021~FY2024는 이자부 차입금이 현금성자산보다 작아 **순현금** 상태였고, FY2025부터 Ansys 인수금융으로 **순부채** 상태로 전환됨. 출처: stockanalysis.com 대차대조표(총차입금·현금및단기투자자산).
...
- **SBC 차감 후 FCF 추세(중요)**: 헤드라인 FCF는 FY2021 $1,400M → FY2025 $1,349M로 완만하게 유지되는 것처럼 보이지만, SBC(비현금 비용이라 FCF에서 차감되지 않음, A.1 참고)를 차감하면 $1,054.7M → $455.7M로 **5개년간 57% 감소**했다. SBC/매출이 8.21%→12.66%로 계속 늘고 있어(A.1), 이 축소 추세가 앞으로도 이어질 가능성에 유의 — 밸류에이션 / 적정주가의 DCF가 SBC 미차감 FCF를 쓰는지 명시할 것.
...
- 현재(2026.8.21 종가 기준) GAAP PER(TTM, 약 92.1배)은 최근 5개년 GAAP PER 평균(약 62.9배)·중앙값(약 57.8배)보다 뚜렷이 높음. 다만 이는 밸류에이션 프리미엄이라기보다 Ansys 인수 관련 상각비·구조조정 비용으로 TTM GAAP EPS($4.32)가 일시적으로 크게 눌린 영향이 큼.
- 반대로 현재 Non-GAAP PER(TTM, 약 29.7배)은 최근 5개년 평균(약 37.8배)·중앙값(약 37.2배)보다 낮아, 6개 구간(FY21~현재) 중 가장 낮은 수준. GAAP과 Non-GAAP PER의 방향성이 엇갈리므로 어느 기준을 쓰느냐에 따라 밸류에이션 판단이 크게 달라짐에 유의.
...
- **이자보상배율이 TTM 기준 약 0.96배로 1배 미만** — FY2021~FY2024엔 최소 36.8배로 이자비용을 넉넉히 감당했으나, Ansys 인수금융으로 이자비용이 FY2024 $36.8M → FY2025 $446.7M로 급증한 데다 같은 기간 GAAP 영업이익도 인수 관련 비용으로 크게 눌리면서(A.1) 최근 4개 분기 GAAP 영업이익이 이자비용을 채 못 채우는 수준까지 낮아졌다(A.3). Non-GAAP 영업이익 기준으로는 훨씬 여유가 있을 것으로 보이나 별도 확인은 못함 — 부채비율 숫자만으로는 드러나지 않는 근시일 재무 부담 신호이므로 밸류에이션 / 적정주가·투자 판단에서 참고할 것.
- **PBR은 5개년 평균(7.35배)이 신호로서 의미가 약함** — Ansys 인수(주식교환 대가)로 자기자본이 FY2024 $89.9억 → FY2025 $283.3억로 3배 급증하며 PBR이 8.99배(FY2024)→2.65배(FY2025)로 급락. 5개년 평균에 인수 전 4년치(8~12배대)가 섞여 있어 과거 쪽으로 크게 치우침 — 밸류에이션 / 적정주가에서 참고용 이하로 취급할 근거.
...
- [stockanalysis.com — SNPS Statistics (2026-08-22 기준 EV·순부채)](https://stockanalysis.com/stocks/snps/statistics/)
