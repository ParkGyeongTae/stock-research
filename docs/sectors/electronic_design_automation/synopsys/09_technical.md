# Synopsys (시놉시스) — 기술적 분석 (일봉 캔들차트 · 지지/저항)
...
- 2025-09-09 장 마감 후 FY2025 3분기 실적 발표([`08_news.md`](./08_news.md) 로그 참고) 이후 다음 거래일(2025-09-10) 시가부터 갭다운.
...
*작성일: 2026-08-15 (최종 수정일: 2026-08-15)*
